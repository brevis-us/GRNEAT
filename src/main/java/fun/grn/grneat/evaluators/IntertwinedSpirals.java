...
//			System.err.print("\t" + args[k]);
	...
	public double evaluate(GRNGenome aGenome) {
		...
		grn.reset();
		grn.evolveMultistep(25);// Warmup

		for( int k = 0; k < num_samples * 2; k++ ) {

			//GRNModel localGRN=fun.grn.grneat.grn.copy();
			...
			localGRN.evolveMultistep(25);// Compute answer
...
//		System.out.println(fun.grn.grneat.grn.toString());
		...
		//GRNModel fun.grn.grneat.grn = GRNModel.loadFromFile("/Users/cussat/Recherche/Projets/grnNEAT/GREAT_GIT/launcher018/IntertwinedSpirals/run_15117926140547400/grn_499_-0.2422680412371134.fun.grn.grneat.grn");
		GRNModel grn = GRNModel.loadFromFile("/Users/kyle/git/GRNEAT2/IntertwinedSpirals/run_1454529429986992000/grn_11_0.0.fun.grn.grneat.grn");
		IntertwinedSpirals eval=new IntertwinedSpirals( args );
		//eval.drawSampledImage(fun.grn.grneat.grn, "/Users/kyle/git/GRNEAT2/IntertwinedSpirals/run_1454529429986992000/ep.png", null, 0.0025);
